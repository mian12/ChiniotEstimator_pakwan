...
import com.alnehal.chiniotestimatorpakwan.ChiniotPackage.ChiniotCartActivity;
...
//    SwipeRefreshLayout srlCart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateValueTextView=findViewById(R.id.dateValue);
        imageViewDate= (ImageView) findViewById(R.id.dateImage);
...
//        });
        ...
        edtPerHead=findViewById(R.id.edPerHead);
...
//        srlCart = (SwipeRefreshLayout) findViewById(R.id.srlCart);
        ...
        etPersons.addTextChangedListener(new TextWatcher() {
                ...
                public void onTextChanged(CharSequence s, int start,
                    ...
                    if (s.length()!=0) {
                        try {
                            int persons = Integer.parseInt(etPersons.getText().toString());
                            if (persons == 0) {
                                persons = 1;
                            }

                            MyApplication.persons=String.valueOf(persons);

                            double totalAmount =Double.parseDouble(tvTotalAmount.getText().toString().trim());



                            double res = totalAmount /(double) persons;


                            edtPerHead.setText(Math.round(res) + "");
                        } catch (Exception e) {
                            e.getMessage();
                        }
                    }
        ...
        if (!MyApplication.persons.isEmpty())
        {
            etPersons.setText(MyApplication.persons);
        }
        if (!MyApplication.vrDate.isEmpty())
        {
            dateValueTextView.setText(MyApplication.vrDate);
        }
...
//
//                int tvTotal=Integer.parseInt(tvTotalAmount.getText().toString());
//
//                            edtPerHead.setText(tvTotal+"");
//
//
//            }
//            else
//            {
//
//                Toast.makeText(context, "kuch ni mila ", Toast.LENGTH_SHORT).show();
//            }
//        }
//        catch (Exception e)
//        {
...
//                    estimateObject.put("oid", oid);
                        ...
                        estimateObject.put("vrdate", dateValueTextView.getText().toString());
                        ...
                        estimateObject.put("persons", etPersons.getText().toString());
                        estimateObject.put("per_head", edtPerHead.getText().toString());
                        //Log.e("data",per_head +"---"+"edit text"+edtPerHead.getText().toString()+"--persons"+persons);
...
//                            edtPerHead.setText(itemModel.getPer_person()+"");
//                            Log.e("per",itemModel.getPer_person()+"");
...
//                itemModelArrayList = databaseHelper.getCartProducts();
        ...
        cartAdapter = new CartAdapter(this, itemModelArrayList, databaseHelper,etPersons,edtPerHead,tvTotalAmount);
    ...
    public void DateDialogMianDate(){
        ...
        DatePickerDialog.OnDateSetListener listener=new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth)
            {
                ...
                MyApplication.vrDate= dateValueTextView.getText().toString();



            }};

        DatePickerDialog dpDialog=new DatePickerDialog(CartActivity.this, listener, year, month, day);
        dpDialog.show();
