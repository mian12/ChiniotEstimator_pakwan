package com.alnehal.chiniotestimatorpakwan.customFillter;
...
public class CustomFillter extends Filter {
    ...
    public CustomFillter(  ArrayList<ExtraDetailCartModel> filterList, MyExtraItemsBaseAdapter adapter)
    {
