...
import com.alnehal.chiniotestimatorpakwan.CartActivity;
...
//            tvWeight = (TextView) view.findViewById(R.id.tvWeight);
    ...
    public CartAdapter(Context context, ArrayList<ItemModel> itemModelArrayList, SQLiteDatabaseHelper databaseHelper,
                       EditText etPersons,EditText  edtPerHead,TextView totaLaMOUNT) {
        ...
        this.etPersons=etPersons;
        this.edtPerHead=edtPerHead;
        this.tvTotalAmount=totaLaMOUNT;
    }
